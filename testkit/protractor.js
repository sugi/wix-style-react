...
export const floatingHelperContentTestkitFactory = protractorUniTestkitFactoryCreator(load(require('../src/FloatingHelperContent/FloatingHelperContent.uni.driver')));
