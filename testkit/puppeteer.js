...
export const floatingHelperContentTestkitFactory = puppeteerUniTestkitFactoryCreator(load(require('../src/FloatingHelperContent/FloatingHelperContent.uni.driver')));
