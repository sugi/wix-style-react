...
export const floatingHelperContentTestkitFactory = puppeteerUniTestkitFactoryCreator(load(require('../src/FloatingHelper/FloatingHelperContent/FloatingHelperContent.uni.driver')));
